  ...
  <div class="auth-page">
    <div class="auth-card glass-panel">
      <div class="auth-header">
        ...
        <p>Mulai kelola portal properti Anda dalam hitungan detik</p>
      </div>
      ...
      <div class="social-buttons">
        <button class="btn-social btn-google" @click="loginWithGoogle" type="button" :disabled="isLoading">
        ...
        <button class="btn-social btn-apple" @click="loginWithApple" type="button" :disabled="isLoading">
      ...
      <p class="auth-footer">
        Sudah punya akun?
        <NuxtLink to="/masuk" class="auth-link">Masuk</NuxtLink>
      </p>
    </div>
  </div>
</template>
